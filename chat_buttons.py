...
system_message = "You are a friendly chatbot called BBot."
...
def comments_system_message():
    global system_message
    system_message = "You will be provided code. You will add comments above each line of code. Comments will be on a single line."
    send_message(entry)  # Send the prompt with the updated system message
...
def initialize_chat_window():
    ...
    comments_system_button = Button(root, text="Add comments", font=user_font, command=comments_system_message)
    comments_system_button.pack(side=tk.LEFT)
